...
> clientAppRegisterPost(registerClientRequestDto)
...
async function example() {
  ...
  const body = {
    // RegisterClientRequestDto (optional)
...
|------------- | ------------- | ------------- | -------------|
| **registerClientRequestDto** | [RegisterClientRequestDto](RegisterClientRequestDto.md) |  | [Optional] |
